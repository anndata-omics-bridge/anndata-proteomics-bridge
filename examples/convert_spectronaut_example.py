"""
Example: Convert Spectronaut output to AnnData format.
...
ANNOTATION_PATH = Path(__file__).parent / "diann_annotation.csv"  # Reusing same annotation
OUTPUT_PATH = Path(__file__).parent / "spectronaut_example_output.h5ad"

def main():
    """Convert Spectronaut data to AnnData."""
    print("=" * 60)
    print("Spectronaut to AnnData Conversion Example")
    print("=" * 60)
    ...
    adata = proteomics_to_anndata(
        ...
        run_col="run",  # Spectronaut uses R.FileName
