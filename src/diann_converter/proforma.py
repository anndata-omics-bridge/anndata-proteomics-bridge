...
def aggregate_modification_sites_column(
    ...
    Used for AlphaDIA format where modifications are in separate columns.
    ...
    input_string_seq : str
        The input sequence string.
    input_string_modifications : str
        The modifications applied to the sequence (semicolon-separated).
    input_string_sites : str
        The positions of the modifications (semicolon-separated).

    Returns
    -------
    str
        The modified sequence string with modification sites in ProForma notation.
    """
